//Normal şartlarda bir bileşeni kullanırken prop gönderiyorsanız,
//test ederken de aynı şekilde prop göndermenizgerekmektedir.
...
test("Gönderilen proplar doğru şekilde kullanıllır",()=>{
   //bileşeni renderla
   ...
   //color propu ile gönderdiğimiz değer clasName de var mı?
